...
public class ParentsRepo {
    ...
    private void MakeTestData() {
        parents.add(new Parent(1, "Kis", "Szonja", false, new Date(1974, 1, 13)));
        parents.add(new Parent(2, "Nagy", "Imre", false, new Date(1974, 7, 7)));
        parents.add(new Parent(3, "Szabó", "Ida", false, new Date(1974, 8, 9)));
        ...
        parents.add(new Parent(12, "Kertész", "László", true, new Date(1974, 3, 12)));
    }
}